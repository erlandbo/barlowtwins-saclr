...
def adjust_learning_rate(args, optimizer, loader, step):
    ...
    base_lr = math.sqrt(args.batch_size)
    ...
    optimizer.param_groups[0]['lr'] = lr * 0.075 #args.learning_rate_weights
    optimizer.param_groups[1]['lr'] = lr * 0.075 #args.learning_rate_biases
...
class SimCLR(nn.Module):
    ...
    def forward(self, y1, y2):
        ...
        hidden = self.projector(self.backbone(y))
